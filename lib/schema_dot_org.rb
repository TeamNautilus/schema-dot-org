...
require 'schema_dot_org/item_availability_type'
require 'schema_dot_org/in_stock'
require 'schema_dot_org/pre_sale'
require 'schema_dot_org/out_of_stock'
require 'schema_dot_org/limited_availability'
...
require 'schema_dot_org/video_object'
